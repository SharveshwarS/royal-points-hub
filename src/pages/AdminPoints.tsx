...
const AdminPoints = () => {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-semibold text-foreground">Points Management</h1>
        <p className="text-sm text-muted-foreground mt-1">Award or deduct employee points</p>
      </div>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <Input value={event} onChange={(e) => setEvent(e.target.value)} placeholder="e.g. Quarterly bonus" />
            </div>
            <div className="space-y-2">
